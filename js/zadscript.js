...
function getJSONPosts() {
  $.get('./posts.php', function(data) {
    ...
    $.each(parsed, function(index, value){
      $('#posts').append("<div id=\"post"+index+"\"><h1>"+parsed[index].title+"</h1><h3>By "+parsed[index].author+" on "+parsed[index].date+"</h3><p>"+parsed[index].body+"<a href=\"mailto:comments@zad0xsis.net\" id=\"commenta\">Comments to comments@zad0xsis.net</a><a href=\"https://twitter.com/share?text='"+parsed[index].title+"' on @zad0xsis blog: https://zad0xsis.net/#/posts/"+index+"\" class=\"twitter-share-button\">Tweet</a><script type=\"text/javascript\" src=\"https://platform.twitter.com/widgets.js\"></script></div><hr />");
    });
